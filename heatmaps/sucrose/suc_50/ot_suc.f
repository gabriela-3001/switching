* evo, if-then, sucrose sw only,time output
* C, 3 switches, D, absolute abundance output
      ...
      parameter (n=5,uu=10.d+00,d=0.01d+00,dd=0.001d+00)
      parameter (ra=0.5d+00,pxx=ra*1.d-06,pyy=(o1-ra)*1.d-06)
      parameter (itend=10**9,itsam=itend/10)
 
      dimension xx0(n),x(n),y(n),z(n),u(n),v(n)
